      ...
      >
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="fv-row mb-7">
              ...
              <el-form-item prop="tax_id">
                <el-input v-model="addItemPayload.data.tax_id" type="text" />
              </el-form-item>
            </div>
          </div>
          <div class="col-md-6">
            <div class="fv-row mb-7">
              ...
              <el-form-item prop="tax_office">
                <el-input
                  v-model="addItemPayload.data.tax_office"
                  type="text"
                />
              </el-form-item>
            </div>
        ...
        <div class="fv-row mb-7">
          ...
          <el-form-item prop="address">
            <el-input
              v-model="addItemPayload.data.address"
